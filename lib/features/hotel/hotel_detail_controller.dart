...
final AutoDisposeFutureProviderFamily<HotelDetail, String> hotelDetailProvider =
    FutureProvider.autoDispose.family<HotelDetail, String>(
  (Ref ref, String hotelId) async {
    final Result<HotelDetail> result =
        await ref.watch(hotelRepositoryProvider).detail(
              hotelId: hotelId,
