...
void main() {
  group('ContentfulResponse', () {
    test('resolves asset and entry links from includes', () {
      final ContentfulResponse response = ContentfulResponse.fromJson(
        _response(),
      );
      final Map<String, Object?> fields = response.fieldsOf(
      ...
      expect(
        (offer['fields']! as Map<String, Object?>)['title'],
        'Stay longer',
      );
    });
    ...
    test('maps into the domain, normalising protocol-relative asset URLs', () {
      ...
      final CmsHotelContent content = CmsHotelContent.fromFields(
